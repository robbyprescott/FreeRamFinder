...
; If you have plans to use LDA #$0B : STA $71 to freeze Mario (through sprites, uberasm, etc), 
; without this hex exit it'll crash the game, since it remaps $1B88’s values

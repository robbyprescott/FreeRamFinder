...
!YPos     = $12 ; Top. The higher the number, the lower down it is. 12 is about 2/3 of the way toward bottom.
...
!White = $18 : !Yellow = $3C : !Red = $2C ; 28 is blue 1C is green. 18 yellow

...
save:
    ...
    ; Feel free to add your own stuff here. For example, moons and dragon coins (see sram_defaults below for this, too):
	; dl $1FEE|!addr : dw 12
    ; dl $1F2F|!addr : dw 12
...
sram_defaults:
    ...
    ; Feel free to add your own stuff here. For example, moons and dragon coins:
	; rep 12 : db $00
    ; rep 12 : db $00

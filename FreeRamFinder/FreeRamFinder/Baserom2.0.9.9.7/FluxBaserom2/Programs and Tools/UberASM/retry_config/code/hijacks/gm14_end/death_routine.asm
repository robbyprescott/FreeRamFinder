...
.no_death_song:
    ...
    ; Play the death SFX. A lot of this added by SJC
    lda $0E1A ; if you want another sound in bank $1DF9
	beq .checkotherbank 
	lda $0E1A ; check value of this address
	sta $1DF9
	bra .return
.checkotherbank 
	lda $0E1B ; if you want a sound in bank $1DFC
	beq .normalSFX 
	lda $0E1B
	sta $1DFC
	bra .return

...
+
    ...
    ; If we're in the intro level or if FreeRAM set, don't Start+Select.
	lda $0109|!addr
	ora $0E07 ; added by SJC
	bne .not_dying 
...
.dying:
	lda $0E82 ; SJC additions: check if FreeRAM set
	beq .vanilladeathpose
	lda $0E82 ; value from this, alternate pose 
	sta $13E0
	bra .keepgoing
.vanilladeathpose:

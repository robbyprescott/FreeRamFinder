...
; Note that by default, (sub)levels accessed through the level hub 
; will still use the timer from the parent/main level, unless you choose the "Force the time limit..." option

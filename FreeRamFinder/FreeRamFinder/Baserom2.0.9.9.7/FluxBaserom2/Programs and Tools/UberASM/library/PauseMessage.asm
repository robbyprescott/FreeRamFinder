incsrc Text/Text.asm ; Text/Text.asm
...
.continue
	LDA $13D3|!addr ; Timer that disables Start from flipping the Pause flag when its value is not #$00
	SEC
	SBC #$3C
	EOR #$FF
	INC
...
.continueChecks	
	...
	BNE .cantUnpauseYet
	LDA $16
	AND #$10 ; if start pressed to initially pause
	BEQ .skip
	JSR Unpause
	RTL
.cantUnpauseYet

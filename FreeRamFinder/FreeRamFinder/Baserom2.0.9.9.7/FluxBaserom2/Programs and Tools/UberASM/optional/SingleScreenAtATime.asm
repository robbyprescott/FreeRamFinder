...
; Minor edits by SJC, for other code compatibility and to freeze animation at death, etc.

; You might need to apply SpriteScrollFix patch if you have spawning problems.
...
!RAM_l1HorzTo = $0EDD	; 2 byte freeram
!RAM_l1VertTo = $0EDF ; 2 byte freeram

; SJC note: This warps you to the level the screen exit is set to.
; If Mario does the normal goal walk, the screen exit should be set for the screen that Mario 
; ENDS at when when he STOPS the goal walk (not where the goal tape itself is).
; If it's an orb, obviously set it to the screen where the orb is. See more detail below.
...
+   stz $88             ;\
	...
	lda #$00
    sta $7FB000         ; music fix, added SJC
    sta $1DFB|!addr
.return
	rtl

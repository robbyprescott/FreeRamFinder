...
macro InitInteractLineHdma(channel, register)
	REP #$20				; A = 16-bit
	LDX.b #<channel><<4
	LDA.w #<register><<8
	JSL InteractionLineGfx_HdmaInit
endmacro

macro CalculateInteractLineHdma(ram_position, sub_offset, line_count)
	REP #$20				; A = 16-bit
	LDA.w #<sub_offset>
	STA $00
	LDA.w #<line_count>
	...
	LDA <ram_position>
	INC
	JSL InteractionLineGfx_CalculateHdma
	SEP #$20
endmacro
...
!InteractionType = $0E0F|!addr	; 8-bit.  ; Default $1929 (not cleared level load)
!InteractionPos = $0E10|!addr	; 16-bit  ; Default $1923

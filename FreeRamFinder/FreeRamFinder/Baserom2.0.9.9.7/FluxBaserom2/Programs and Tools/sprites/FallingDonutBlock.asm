...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        !DONUT_MAP16_NUM = $02b9             ; map16 value of the donut block in hex        
        !DONUT_SPRITE_TILE = $A4             ; graphic tile to use for donut sprite
...
DONUT_CODE_START:
    ...
    CLC : ADC #$02
    STA !AA,x
+   JSL $01801A|!bank       ;sets speed

    LDA #$01                ;keep timer at #$01 timer (we're falling already)
    STA !1558,x

.timer
    JSL $01B44F|!bank       ;interact with sprite
...
+   LDA $00                   ; \ tile x position = sprite x location ($00)
    ...
    LDA.b #!DONUT_SPRITE_TILE ; \ store tile
    STA $0302|!Base2,y        ; /

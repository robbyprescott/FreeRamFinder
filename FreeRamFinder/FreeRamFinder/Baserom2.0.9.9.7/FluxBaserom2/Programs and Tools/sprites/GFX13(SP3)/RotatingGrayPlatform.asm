; Works in GFX13 or ExGFX113 (SP3). This frees up SP4 to use whatever you want, without having to use GFX05 just for the chain "ball" thing
...
Tilemap:		db $6B,$60,$61,$62 ; SJC, normally A2,60... 

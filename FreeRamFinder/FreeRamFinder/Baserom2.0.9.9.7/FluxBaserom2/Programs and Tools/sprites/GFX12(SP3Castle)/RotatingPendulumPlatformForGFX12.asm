; Ball connector remapped for GFX 13 (SP3), so that you're not required to put anything specific in SP4 (normally GFX05)
...
Tilemap:		db $43,$60,$61,$62 ; SJC, normally A2,60...

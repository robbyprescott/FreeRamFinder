...
; This lets sublevel have their own message box, too.
; Simply put the level number in the extra property byte.
; For level numbers above 101, use the
; following hex-to-hex conversion formula:
...
;Remember that, like the vanilla, which one of the two possible messages it will display for each (sub)level is x-position dependent.

...
;;
;; SJC: Added code by Fernap for glitch fixes
;;
...
PowInteract:
	...
	lda $1470|!Base2 : ora !PlayerRideYoshi : ora !163E,x : bne .No_Carry
	; The previous line fixes the carry-already-pressed-switch glitch. The original was
...
.No_Carry
    ...
    lda !1686,x : ora #$01 : sta !1686,x   ; no Yoshi-eat duplicate glitch

...
;                                    ;
; Edited to only start moving when   ;
; mario isn't standing on it         ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

; Edit by codfish1002

;NOTES:
;if the extra bit is set platform will stop moving if mario isn't standing on it. 
;(this option doesn't work very well since the platform will just desync)

; Minor fixes by KevinM, added by SJandCharlieTheCat
...
BNE +	; don't interact with the sprite
...
+ LDA !163E	; unless the grab timer is already zero...
BEQ Return00	;
STZ !163E,x	; clear it

; SJC notes: If you want to insert a custom sprite that its own extra bytes into the stack,
; refer to SpriteStackCustomWrapper.asm for instructions.
...
!Platform = $0EF4|!addr ; FreeRAM for finding platform sprite

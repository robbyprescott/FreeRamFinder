; This will retain the fall-off-the-platform jank that's patched for the normal vanilla sprite 
...
GreyFallingPlat:
	...
	CLC
	ADC.b #$02              ; Increase the speed by 2 all the time (until it's above 40).                

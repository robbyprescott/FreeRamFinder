...
;; asar support by JackTheSpades. Abdu mods
;;
;; Description: 
;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        !DONUT_MAP16_NUM = $05AD             ; map16 value of the donut block in hex        
        !DONUT_SPRITE_TILE = $2D             ; graphic tile to use for donut sprite
...
DONUT_CODE_START:
		...
		LDA !B6,x               ;if X speed = 0, jumps to timer code
		BEQ .timer
		
		LDA !B6,x               ;caps X speed at #$38
		CMP #$38  
		BPL + 
		CLC : ADC #$02   
		STA !B6,x

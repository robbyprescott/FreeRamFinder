; Uses ExGFX113 in SP3, and custom palette

; Will install patch if !FreezeTimeWhenTeleporting = 1 (not enabled by default)
; You'll need to use the GFX in the included extra sprite ExGFX and insert the correct tilemap values here
        ...
        ; FreeRAM Used: $0EE4 and $0EE5


        ; Stuff you can change

        !TeleportingSpeed = $00                 ; Speed the camera/teleport moves, default $40
        !FreezeTimeWhenTeleporting = 0          ; 0 = no, 1 = yes
        !CurrentTeleportTarget = $0EE4|!Base2   ; freeRAM value with the index of the last touched sprite of this type

        !DashSpeed = #$00                       ; Rightward Speed post-teleport, default #$50
        !DashSpeedNegative = #$FF               ; Leftward Speed post-teleport, default #$AF
        !UpSpeed = #$FF                         ; Upward Speed post-teleport, default #$9F 
        !DownSpeed = #$00                       ; Downward Speed post-teleport, default #$40
        ...
        !Tile = $43                             ; Initial tile
        !SwappedTile = $4B                     ; Palette swapped version of the tile to indicate being ready to teleport
        !TeleportingTile = $4E                  ; Explosion tile used when teleporting is activated
        ...
        !FreezeRAM  =   $0EE5|!Base2    ; 1 byte of free RAM.

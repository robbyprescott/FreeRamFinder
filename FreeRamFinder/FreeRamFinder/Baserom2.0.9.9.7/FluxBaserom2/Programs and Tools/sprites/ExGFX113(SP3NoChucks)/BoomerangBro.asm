; Use with ExGFX103 in SP3. (This is basically GFX13)
...
!BoomerangNumber = $08      ; Extended sprite number (from list.txt) of the boomerang (boomerang.asm).

TILEMAP:	db $2B,$66,$7F,$69		;last byte is for "hammer" (all tables). 6D instead of default 4E?
		db $2B,$76,$3F,$69
		db $04,$66,$7F,$69
		db $04,$76,$3F,$69

; SJC: managed to rearrange things so that the only forest sprite's GFX this affects is the wiggler.
; Use with optional ExGFX106 (?) in SP4
...
!BanzaiGFX3	=	$CE	;tile of the almost upper left part of the sprite. It's also used for the bottom part.
!BanzaiGFX4	= 	$EA	;tile of the upper right part of the sprite. It's also used for the bottom part.
!BanzaiGFX5	=	$85	;tile of one of the 1st eye part of the sprite.
!BanzaiGFX6	=	$87	;tile of the 2nd eye part of the sprite.
...
!BanzaiGFX12	=	$EE	;tile of the last part of the GFX file of the sprite's mouth.

; SJC notes: This sprite will spawn whatever sprite number you put in extra byte 1
; Its x or y-position can be offset by the number of pixels in extra byte 3 or 4, though.

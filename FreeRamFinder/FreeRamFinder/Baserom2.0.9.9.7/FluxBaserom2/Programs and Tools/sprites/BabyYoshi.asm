...
; SJC: Note that if you use this custom disassembled baby Yoshi
; instead of the vanilla one, it'll still glitch the GFX if you have
; baby and adult Yoshi together. (This is fixed for the vanilla baby Yoshi, though.)

; SJC: I've halved the growing animation timer at line 346
...
!UseCustomTiles = 0		;Set to 1 if you want to point to actual tiles on the tilemap and set the tilemap to those tiles
!CustomTilesPage = 0	;0 for page 1, 1 for page 2, only used with custom tile map

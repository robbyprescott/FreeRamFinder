; Note that throwing it into blocks that have certain non-solid acts-as 
; will cause it to be destroyed. A coin is one of these.
...
;Free RAM address
!FreeRAM = $0EF0|!Base2		;used by the block to determine if it can be picked up or not. Make sure it's the same address used by the block.

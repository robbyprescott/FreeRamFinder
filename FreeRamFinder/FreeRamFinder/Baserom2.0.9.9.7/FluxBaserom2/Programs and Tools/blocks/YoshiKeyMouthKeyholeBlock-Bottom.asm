...
print "Can only be unlocked when you have a key in Yoshi's mouth. (This is the bottom block of a two-block pair.) Don't use in true vertical levels! If you had planned on doing this, use the tall horizontal level mode to emulate a vertical level instead."
...
print "Works like a normal question mark block, but can set this to spawn any block ABOVE the original block when hit. You can also set the original to turn into something other than a brown used block. Note that it'll kill Mario if he hits it from below (certainly if act-as is 12F, etc.)."

!BlockToSpawn = $0283 ; 283

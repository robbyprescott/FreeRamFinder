...
;options:
!KillFromAboveIfYoureNotBigOrSpinning = 1
...
!bounce_properties	= $08			;>The properties of bounce blocks (palette, tile number high byte)
...
KillIfSmallAbove:
     if !KillFromAboveIfYoureNotBigOrSpinning
     JSL $00F606
     endif
	 RTL

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Extending block. Upwards growing block.
; By TheBiob
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

!sprite	= $A1					; Sprite number of the sprite
...
if !use_multiple_timer
	...
	BNE R0
	REP #$20
		LDA $9A		; \ Get top left corner of the block
		AND #$FFF0	; |
		STA $9A		; |
		LDA $98		; |
		AND #$FFF0	; |
		STA $98		; /
		SEC : SBC.w #!extendsize<<4
		STA $0C
	SEP #$20
	LDX #!SprSize-1
-		LDA !7FAB10,x	; \
		...
		LDA !E4,x		; |
		REP #$20		; |
			CMP $9A		; | Kill all sprites that are already in the block area so they don't cause problems
			BNE +		; |
		SEP #$20		; |
		LDA !14D4,x		; |
		XBA				; |
...
+	SEP #$20 : DEX : BPL -
	...
	LDA $98			; \ Store position so the sprite knows where to return to
	STA !lowbyte,x	; |
	LDA $99			; |
	STA !highbyte,x	; /
if !use_multiple_timer
...
print "This block can grow up to ", dec(!extendsize), " tiles upwards when hit from below or the side. Don't use in true vertical levels! If you had planned on doing this, use the tall horizontal level mode to emulate a vertical level instead."
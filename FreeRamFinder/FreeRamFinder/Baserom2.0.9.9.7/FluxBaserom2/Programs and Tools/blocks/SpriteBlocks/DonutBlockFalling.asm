...
;based on mikeyk's code, adapted by Davros.
	...
	!CUSTOM_SPRITE = $AD    ;>custom sprite number to generate
...
print "A Donut Lift, which will FALL shortly after being stepped on, or not + reset its timer if you step off quickly enough."
;Sample ? block which spawns a rotating vine starting right
...
!ExtraByte2 = $03	; Second extra byte
!ExtraByte3 = $00	; Third extra byte
!ExtraByte4 = $00	; Fourth extra byte

!XPlacement = $10	; Remember: $01-$7F moves the sprite to the right and $80-$FF to the left.
...
print "Growing vine block, vine moves rightward when hit. Customizable speed."
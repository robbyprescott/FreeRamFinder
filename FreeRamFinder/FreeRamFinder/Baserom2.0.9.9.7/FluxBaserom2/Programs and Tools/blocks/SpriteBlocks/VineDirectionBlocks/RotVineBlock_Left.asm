;Sample ? block which spawns a rotating vine starting left
...
!ExtraByte2 = $02	; Second extra byte
!ExtraByte3 = $00	; Third extra byte
!ExtraByte4 = $00	; Fourth extra byte

!XPlacement = $F0	; Remember: $01-$7F moves the sprite to the right and $80-$FF to the left.
...
print "Growing vine block, vine moves leftward when hit. Customizable speed."
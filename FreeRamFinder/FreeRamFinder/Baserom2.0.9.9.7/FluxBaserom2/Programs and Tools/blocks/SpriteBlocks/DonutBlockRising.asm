...
;based on mikeyk's code, adapted by Davros.
	...
	!CUSTOM_SPRITE = $AA    ;>custom sprite number to generate
...
print "A Donut Lift, which will RISE shortly after being stepped on, or not + reset its timer if you step off quickly enough."
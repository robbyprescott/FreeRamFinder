;The top-right of the custom switch palace switch.
;Acts like $130
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	REP #$10		;\Change the top right block.
	LDX #!TopRight		;|
	%change_map16()		;|
	SEP #$10		;/
...
YPosShft:
	dw $0000, $0010, $0000
TileChangeTbl:
	dw !BottomRight, !BottomLeft, !TopLeft

print "The top-right part of a 32x32 switch palace switch. By default this will NOT activate the normal switch palace switch stuff (not even the message). Instead, hitting it will simply press the switch down and activate an arbitrary RAM address ($0E1D), which you can then use for other purposes (including, for example, DelayBeforeRunningCodeTemplate.asm); or you can also set it to activate a specific color switch, too."
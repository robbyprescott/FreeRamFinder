...
print "Right-moving conveyor. Direction controlled by on/off switch."

; To adjust speed, increase ADC #$01, and then adjust other corresponding
...
mario_add:
	LDA $94              ;\
	CLC                  ;|
	ADC #$03             ;| normal 01. increase this to increase overall speed, and match elsewhere
	STA $94              ;|mario xpos + 1
	LDA $95              ;|
	ADC #$00             ;|
	STA $95              ;/

...
!SpriteNum              = $DA   ; the sprite number to spawn
!Custom                 = 0     ; if set it will spawn a custom sprite
!UseCustomState         = 1     ; if set !CustomSpawnedState will be the state of the spawned sprite.
...
if !Custom
    print "If hit by the magic sprite it will spawn the custom sprite ", hex(!SpriteNum),"."
else
    print "If hit by the magic sprite it will spawn the vanilla sprite ", hex(!SpriteNum),"."
endif
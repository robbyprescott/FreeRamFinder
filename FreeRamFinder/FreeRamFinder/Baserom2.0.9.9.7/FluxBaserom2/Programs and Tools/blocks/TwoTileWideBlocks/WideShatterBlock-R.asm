...
print "Right tile of the two-tile wide shatter block. Will be shattered by kicked sprites, Mario below, or big Mario spin-jump from above. Don't use in true vertical levels! If you had planned on doing this, use the tall horizontal level mode to emulate a vertical level instead."
...
print "Question block that spawns a p-balloon. Requires GFX02 (or 0E) in SP4. (GFX flipped at spawn, though.)"

!Sprite = $7D	; sprite number
!IsCustom = CLC ; CLC for normal, SEC custom sprite
!SetExtraBit = 0
!State = $08	; Usually $08 for normal, $09 for carryable sprites

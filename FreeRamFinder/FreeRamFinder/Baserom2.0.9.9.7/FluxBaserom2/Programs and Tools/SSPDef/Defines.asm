;If you make changes here, make sure you apply the changes to the other copy of this file, in Patches folder
...
;RAM address.
 ...
 if !sa1 == 0
  !Freeram_SSP_PipeDir		= $7E0EA1 ; $7E0060
 else
  !Freeram_SSP_PipeDir		= $0EA1
 endif
 ...
 if !sa1 == 0
  !Freeram_SSP_PipeTmr		= $7E0EA2 ; $7E0061
 else
  !Freeram_SSP_PipeTmr		= $0EA2
 endif
 ...
 if !sa1 == 0
  !Freeram_SSP_EntrExtFlg	= $7E0EA3 ; $7E0062
 else
  !Freeram_SSP_EntrExtFlg	= $0EA3
 endif
 ...
 if !sa1 == 0
  !Freeram_SSP_CarrySpr		= $7E0EA4 ; $7E0063
 else
  !Freeram_SSP_CarrySpr		= $0EA4
 endif
 ...
 ;be warped to (via dragging the player towards that location).
  if !sa1 == 0
   !Freeram_SSP_DragWarpPipeDestinationXPos = $0EA6
  else
   !Freeram_SSP_DragWarpPipeDestinationXPos = $0EA6|!addr
  endif
  if !sa1 == 0
   !Freeram_SSP_DragWarpPipeDestinationYPos = $0EA8
  else
   !Freeram_SSP_DragWarpPipeDestinationYPos = $0EA8|!addr
  endif
...
;so that you can multiple blocks with different variations (such as having some pipe caps that allow carrying sprites or allowing yoshi).
 ...
 !Setting_SSP_PipeDebug		= 0
  ...
  ; When turned on, Mario INTERACTS with sprites in his path (causes them to face his direction and take damage, for example) .
 ...
 !Setting_SSP_VerticalCapsEnterableWidth	= $000B ; default $0005

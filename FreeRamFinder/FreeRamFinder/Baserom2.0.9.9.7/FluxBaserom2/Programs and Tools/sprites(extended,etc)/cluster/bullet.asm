; There were several updates to this since this version.
; These updates added features and fixed a couiple of issues,
; though apparently caused other issues, too.
; Update at your own risk: https://github.com/MarkAlarm/SMW-Public/tree/main/Cluster%20Bullet%20Shooter

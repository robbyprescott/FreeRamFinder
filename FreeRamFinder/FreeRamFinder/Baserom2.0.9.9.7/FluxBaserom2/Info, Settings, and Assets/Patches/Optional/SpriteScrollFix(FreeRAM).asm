; Might need to use this if you have spawning problems with the Single Screen UberASM

!Freeram_PrevPos	= $0EEC     
...
BetterScrollY:
	...
	BNE +                   ;|
	JML $00F7F9             ;>You cannot RTS on freespace if JML (must end on correct bank).
+	JML $00F7FA             ;/

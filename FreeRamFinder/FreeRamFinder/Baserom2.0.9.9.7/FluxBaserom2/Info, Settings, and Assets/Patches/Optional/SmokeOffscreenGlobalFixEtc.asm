...
!high_x			= $0E9C|!addr			; 4 consecutive bytes of FreeRAM. Default was $18C9, cleared at level load
!high_y			= $0E88|!addr			; 4 consecutive bytes of FreeRAM. Default was $18C5, cleared at level load

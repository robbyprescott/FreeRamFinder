; Fix for compatibility, sprite properties on extra bit

; Very slight modification by SJC
...
States:
db $04,$05,$05,$0C,$08,$08,$09,$0A		; Former $FF changed to 08, clappin' Chuck (see below). $0C is Whistling but that's already handled before our patch.

; The sixth value in States above points to unused chuck sprite 96. If set as...

; Note that after you patch this, the sprites that usually change 
; based on their x-position WILL NO LONGER DO SO, UNLESS you set the extra bit! 
; For example, there will only ever be message box #1, or blue p-switches, 
; wherever you place them. Set the extra bit to get message box #2, silver p-switch, etc.  

; You can disable this for specific sprites, though. I'd recommend disabling
; for message boxes, for example (how often will you not find the right x-position for it?)
...
;===================================================================;
!Sprite09 = 0                   ; DON'T USE THIS. Green bouncing Koopa

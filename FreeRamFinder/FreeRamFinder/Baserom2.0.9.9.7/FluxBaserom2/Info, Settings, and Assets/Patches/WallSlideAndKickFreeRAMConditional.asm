...
!allow_spinjump		= !true		; Whether or not player may spin jump off of walls.
...
!flags			= $0E70		; The wallkick flags. (RAM)
!no_back_timer		= $0E71		; The timer for not moving back. (RAM)
!temp_y_spd		= $0E72		; The temporary Y speed. (RAM)

!SpinJumpSFX = $04  ; Spin jump sound effect. 1DFC
!JumpSFX = $35      ; Regular jump sound effect. 1DFC
...
wall_kick:
		...
		JSL $0586F1|!bank			; Replace hijacked code

; Unlike the other SSP patch, which is required to make the SSPs functional at all,
; this patch (which fixes a number of sprite issues that it's possible to run into with the SSPS)
; introduces some amount of sprite lag globally in certain situations.

; Note that this contains an incsrc, "SSPDefines.asm"

; September 2021 update, mechakoopas were broken because of $01A162. Fixed now.

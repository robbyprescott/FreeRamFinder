...
;
;Potentially incompatible with Inline layer 3
;
...
; Do note that it uses a small amount of unused ROM space in bank 0.
...
!freespace_bank0 = $00F9F5 ; SJ moved from $00BA56, so no conflict with PlayerSelectReplaced patch

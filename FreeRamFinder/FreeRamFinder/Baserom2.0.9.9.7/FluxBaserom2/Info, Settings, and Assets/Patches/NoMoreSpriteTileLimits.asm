...
; Yoshi/Lakitu issue might be solved by commenting out
; %speedup($34) and changing LDA.b #$30 to LDA.b #$38	 
 
!FreeRAM = $0E1F 
!foundSlot = PickOAMSlot_foundSlot

!OldSpriteHeader = 0 ; if 0, use $08 to bybass NMSTL
!sprite_header = $10 ; if above not 0
!EnabledForOnlyOneHeader = 0 ; not necessary/available anymore; I replaced with a FreeRAM condition
...
PickOAMSlot:
    LDA.w !FreeRAM
    BNE .default ; added by SJC
;if !EnabledForOnlyOneHeader
	;LDA.w $1692             ; \  if sprite header
	;CMP.b #!sprite_header              ;  | setting is not X (default header $10),
